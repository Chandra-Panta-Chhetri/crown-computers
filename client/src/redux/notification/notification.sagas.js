...
function* watchErrorNotifications() {
  yield takeEvery(
    [
      ...
      PRODUCT_CATEGORY_ACTION_TYPES.FETCH_ALL_PRODUCT_CATEGORIES_FAIL,
      PRODUCT_CATEGORY_ACTION_TYPES.DELETE_CATEGORY_BY_ID_FAIL,
      ...
      PRODUCT_ACTION_TYPES.DELETE_PRODUCT_BY_ID_FAIL,
      PRODUCT_ACTION_TYPES.CREATE_NEW_PRODUCT_FAIL,
      PRODUCT_ACTION_TYPES.UPDATE_PRODUCT_BY_ID_FAIL
    ],
...
function* watchSuccessNotifications() {
  yield takeEvery(
    [
      PRODUCT_CATEGORY_ACTION_TYPES.DELETE_CATEGORY_BY_ID_SUCCESS,
      ...
      PRODUCT_ACTION_TYPES.DELETE_PRODUCT_BY_ID_SUCCESS,
      PRODUCT_ACTION_TYPES.CREATE_NEW_PRODUCT_SUCCESS,
      PRODUCT_ACTION_TYPES.UPDATE_PRODUCT_BY_ID_SUCCESS
    ],
